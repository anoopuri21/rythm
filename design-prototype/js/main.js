...
const CATEGORIES = [
  [
    "Guitars",
    "480+ instruments",
    "https://www.bajaao.com/cdn/shop/files/FEN-0373152506.jpg?v=1779349747",
  ],
  [
    "Ukuleles & Violins",
    "80+ ukuleles",
    "https://www.bajaao.com/cdn/shop/files/kala-soprano-ukuleles-kala-makala-mk-s-soprano-ukulele-18300244328609.jpg?v=1686443810",
  ],
  [
    "Keyboards & Pianos",
    "210+ instruments",
    "https://www.bajaao.com/cdn/shop/files/ROL-FP30XBK.jpg?v=1779349747",
  ],
  [
    "Studio & Recording",
    "260+ essentials",
    "https://www.bajaao.com/cdn/shop/files/FCR-SCR2I24.jpg?v=1782732174",
  ],
  [
    "Drums & Percussion",
    "190+ instruments",
    "https://www.bajaao.com/cdn/shop/files/ALE-NITROMAXKIT.jpg?v=1780654577",
  ],
  [
    "Software & Plugins",
    "150+ titles",
    "https://www.bajaao.com/cdn/shop/files/ableton-daw-software-ableton-live-12-suite-software-download-only-1160354569.jpg?v=1768302320",
  ],
  [
    "Live Sound",
    "160+ systems",
    "https://www.bajaao.com/cdn/shop/files/Mackie_revised_Website_Banner_1400_x_486.jpg?v=1776311162",
  ],
  [
    "Indian Instruments",
    "140+ instruments",
    "https://www.bajaao.com/cdn/shop/files/ultimate-guru-other-indian-percussion-taal-sangat-digital-tabla-12538672771.jpg?v=1688490765",
  ],
  [
    "Wind Instruments",
    "120+ instruments",
    "https://www.bajaao.com/cdn/shop/files/vault-harmonicas-red-vault-ha500-key-c-10-hole-harmonica-29054261919923.jpg?v=1744670088",
  ],
  [
    "Accessories",
    "900+ essentials",
    "https://www.bajaao.com/cdn/shop/files/ernie-ball-electric-guitar-strings-ernie-ball-2239-super-slinky-rps9-electric-guitar-strings-34264274206899.png?v=1707561395",
  ],
];
...
const PRODUCTS = [
  ...
  [
    ...
    42,
    null,
    "https://www.bajaao.com/cdn/shop/files/yamaha-acoustic-guitars-tobacco-brown-sunburst-single-yamaha-f310-acoustic-guitar-23024704127155.jpg?v=1741589015",
  ],
  [
    "Kala",
    "Kala Makala MK-S Soprano Ukulele",
    4999,
    null,
    18,
    null,
  ...
  [
    ...
    25,
    "Premium",
    "https://www.bajaao.com/cdn/shop/files/roland-synthesizers-roland-jupiter-xm-rising-jupiter-series-synthesizer-1176521097.png?v=1768280708",
  ],
  [
    "Akai",
    "Akai MPK Mini Play Controller Keyboard",
    9375,
    null,
    61,
    null,
    "https://www.bajaao.com/cdn/shop/files/akai-midi-keyboards-mk3-akai-mpk-mini-play-mini-controller-keyboard-with-built-in-speakers-with-mpc-beats-software-pack-1177300429.jpg?v=1769755592",
  ],
  [
    "Focusrite",
    "Focusrite Scarlett 2i2 4th Gen Interface",
    26533,
    null,
    33,
    "New",
  ...
  [
    "KRK",
    "KRK Classic 7 Studio Monitor",
    22299,
    null,
    27,
    null,
    "https://www.bajaao.com/cdn/shop/files/krk-monitor-speakers-krk-classic-7-active-2-way-professional-studio-monitor-single-black-31865208471731.jpg?v=1687776513",
  ],
  [
    "Audio-Technica",
    ...
    54,
    "Popular",
    "https://www.bajaao.com/cdn/shop/files/audio-technica-headphones-audio-technica-ath-m20x-headphones-22877388439731.jpg?v=1742013789",
  ],
  [
    "Audio-Technica",
    "ATM510 Cardioid Microphone",
    8200,
    null,
    19,
    null,
    "https://www.bajaao.com/cdn/shop/files/audio-technica-dynamic-microphones-audio-technica-atm510-cardioid-dynamic-handheld-microphone-13893553881160.jpg?v=1688169095",
  ],
  [
    "Alesis",
    "Alesis Nitro Pro XL Electronic Drum Kit",
    90608,
    null,
    38,
    "Deal",
    "https://www.bajaao.com/cdn/shop/files/alesis-electronic-drum-kits-alesis-nitro-pro-xl-10-piece-electronic-drum-kit-with-mesh-heads-bluetooth-1187135840.jpg?v=1768145949",
  ],
  [
    "Roland",
    "Roland EC10 El Cajon Hybrid Cajon",
    57485,
    null,
    22,
    null,
    "https://www.bajaao.com/cdn/shop/files/roland-cajons-roland-ec10-el-cajon-hybrid-cajon-1176521320.png?v=1768094242",
  ],
  [
    "Ultimate Guru",
    "Taal Sangat Digital Tabla",
    6200,
    null,
    17,
    null,
  ...
  [
    "Ernie Ball",
    "Super Slinky RPS9 Electric Guitar Strings",
    909,
    null,
    30,
    null,
  ...
  [
    "Granada",
    "Adagio Complete Violin with Bow & Case",
    7505,
    null,
    12,
    "New",
    "https://www.bajaao.com/cdn/shop/files/granada-violins-granada-adagio-complete-violin-with-bow-case-full-size-34991213772979.jpg?v=1714818097",
  ],
  [
    "Casio",
    ...
    29,
    null,
    "https://www.bajaao.com/cdn/shop/files/casio-digital-pianos-casio-privia-px-860-88-key-digital-piano-with-piano-stool-12837748867.jpg?v=1686255161",
  ],
];

const HERO_SLIDES = [
  {
    img: "images/independent-day-sale.png",
    label: "High quality · Best sellers",
  },
  { img: "images/banner-0.png", label: "High quality · Best sellers" },
  { img: "images/banner-1.png", label: "The Rhythm Exports standard" },
  { img: "images/banner-2.jpeg", label: "High quality · Keys & pianos" },
  { img: "images/banner-3.png", label: "Live stages" },
  { img: "images/banner-4.png", label: "Home studios" },
];

const STORIES = [
  [
    "Setup",
    "Why every Rhythm Exports guitar is stage-ready out of the box",
    "4 min read",
    "How we set up",
    "images/story1.jpg",
  ],
  [
    "Studio",
    "Building your first home studio without breaking the bank",
    "6 min read",
    "The budget studio",
    "images/story2.jpg",
  ],
  [
    "Practice",
    "A 30-day practice plan that actually sticks",
    "5 min read",
    "30 days of progress",
    "images/story3.jpg",
  ],
...
const TESTIMONIALS = [
  [
    ...
    "The guitar arrived perfectly set up — low action, spot-on intonation, and packed like it was touring the country. It felt personal, not transactional.",
  ],
  [
    "Naina Kapoor",
    "Singer-songwriter · Delhi",
    "NK",
    "Studio recording bundle",
    "I was building my first home studio and the advice was refreshingly honest. Rhythm Exports helped me spend where it mattered and save where it did not.",
  ],
  [
    "Rohan Iyer",
    "Keys player · Bengaluru",
    "RI",
    "Yamaha CK61 Stage Keyboard",
    "From the first call to delivery, everyone spoke the language of musicians. My keyboard reached Bengaluru ahead of schedule and was ready for rehearsal.",
  ],
  [
    "Ishita Sen",
    "Classical musician · Kolkata",
    "IS",
    "Professional brass tabla set",
    "Finding an authentic tabla set online felt risky. The detailed consultation, careful tuning, and beautiful instrument changed my mind completely.",
  ],
];
...
const FAQS = [
  [
    ...
    "Metro cities receive orders in 2–4 working days; most other locations in 4–7 working days. Every order ships with tracking and signature-on-delivery, and shipping is free above ₹999.",
  ],
  [
    "Can I return an instrument if I change my mind?",
    "Yes — you have 7 days from delivery for easy, no-questions returns on unused products in original packaging. Instruments that are played and then returned are covered by our separate 7-day play-trial policy for select guitars and keyboards.",
  ],
  [
    "Do you offer EMI or easy payment options?",
    "Yes — no-cost EMI is available on leading credit cards, and we support UPI, net banking, wallets and cash on delivery for eligible orders. The full list of options appears at checkout.",
  ],
  [
    "Are instruments set up before shipping?",
    "Every guitar, bass, ukulele and keyboard is inspected, tuned and set up by our in-house technicians before dispatch — free of charge. This includes action, intonation and string checks.",
  ],
  [
    "How do I get expert buying advice?",
    "Call or WhatsApp our team of working musicians for honest, product-specific advice — no scripts. We will help you compare models, plan upgrades and even recommend the right cable.",
  ],
];
...
const UGC = [
  [
    "@ria.makes.music",
    "Tracking vocals on her first studio bundle",
    "images/ugc1.jpg",
  ],
  [
    "@akash.plays",
    "Sunday mornings with the CS11 and a window seat",
    "images/ugc2.jpg",
  ],
  [
    "@decks.by.dev",
    "Weekend sets on a Rhythm Exports-sourced rig",
    "images/ugc3.jpg",
  ],
];
...
const MENU = [
  ...
  [
    ...
    "indian-instruments",
    CATEGORIES[7][2],
    ["Tabla", "Sitar", "Harmonium", "Dholak", "Other Percussion"],
  ],
  [
    "Wind Instruments",
    "wind-instruments",
    CATEGORIES[8][2],
    ["Harmonicas", "Flutes", "Saxophones", "Trumpets", "Clarinets"],
  ],
  [
    "Accessories",
    "accessories",
  ...
  (e) => {
    ...
    if (t.tagName === "IMG") {
      const wrap = t.closest(
        ".pcard__imgwrap, .cat-card, .ugc-card, .hero__slide, .why__frame, .showcase__poster",
      );
      if (wrap) {
        ...
        ph.textContent = "♪";
        ph.style.cssText =
          "position:absolute;inset:0;display:grid;place-items:center;font-size:3rem;color:rgba(0,0,0,.18);background:#f2f2f2;";
        wrap.appendChild(ph);
      }
    }
  },
...
function renderMegaList() {
  ...
  MENU.forEach(([name], i) => {
    ...
    b.addEventListener(
      "mouseenter",
      selectCat,
    ); /* hover pe right panel switch */
    b.addEventListener(
      "click",
      selectCat,
    ); /* click bhi kaam kare, collapse nahi */
...
endCard.href = "#";
endCard.className = "gcard gcard--end";
endCard.innerHTML = `
  <div>
...
function onPinScroll() {
  ...
  $("#pin-count").textContent =
    String(idx).padStart(2, "0") + " / " + CATEGORIES.length;
}
let pinTick = false;
...
window.addEventListener(
  "load",
  measurePin,
); /* images/fonts ke baad re-measure */
...
[...PRODUCTS, ...PRODUCTS.slice(0, 2)].forEach((p) =>
  track.appendChild(pcard(p)),
);
...
const gap = 22;
const slideW = () =>
  (track.parentElement.clientWidth - gap * (perView() - 1)) / perView();
...
function carouselAuto() {
  ...
  carouselTimer = setInterval(() => nextProduct(), 4500);
}
...
window.addEventListener("resize", () => {
  clearTimeout(rszT);
  rszT = setTimeout(() => updateCarousel(true), 200);
});
...
const brandCat = (b) =>
  ["Fender", "Yamaha", "Kala", "Granada"].includes(b)
    ? "Guitars"
    : ["Roland", "Casio", "Akai"].includes(b)
      ? "Keys"
      : ["Alesis"].includes(b)
        ? "Drums"
        : "Pro Audio";
bsTabs.innerHTML = cats
  .map(
    (c) =>
      `<button class="tab${c === "all" ? " active" : ""}" data-cat="${c}">${c === "all" ? "All hits" : c}</button>`,
  )
  .join("");
function renderBS(cat) {
  ...
  const list =
    cat === "all"
      ? PRODUCTS.slice(0, 8)
      : PRODUCTS.filter((p) => brandCat(p[0]) === cat).slice(0, 4);
...
[PRODUCTS[0], PRODUCTS[13], PRODUCTS[14]].forEach((p) =>
  arrGrid.appendChild(pcard(p)),
);
...
function goT(n) {
  ...
  $$(".carousel__dot", tDots).forEach((d, i) =>
...
faqList.addEventListener("click", (e) => {
  ...
  $$(".faq__item.open").forEach((x) => {
    x.classList.remove("open");
    $(".faq__a", x).style.maxHeight = "0";
  ...
  (es) =>
    es.forEach((en) => {
      ...
      (function tick(t) {
        ...
        el.textContent =
          (end * eased).toLocaleString("en-IN", {
...
if (dealTimer) {
  ...
  setInterval(() => {
    ...
    const set = (u, v) => {
      const el = $(`[data-unit="${u}"]`, dealTimer);
