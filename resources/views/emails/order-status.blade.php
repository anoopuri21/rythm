...
<head>
    ...
    <style>
        ...
        .status { display: inline-block; margin-top: 12px; background: #111111; color: #fff; padding: 8px 18px; border-radius: 999px; font-size: 13px; font-weight: 700; text-transform: uppercase; letter-spacing: .08em; }
        .btn { display: inline-block; margin-top: 24px; background: #111111; color: #fff; text-decoration: none; padding: 13px 26px; border-radius: 999px; font-size: 14px; font-weight: 700; }
