...
@php
    ...
    $stories = $homepage['stories']->map(fn ($b, $i) => [
        ...
        'title' => $b->title,
        'excerpt' => $b->content,
        'image' => $b->getFirstMediaUrl('image') ?: ['images/story-studio.jpg','images/story-guitar.jpg','images/hero/grid-banner-piano.jpg'][$i % 3],
    ...
    $storiesFallback = [
        ...
        ['category'=>'Buying guide','title'=>'Your first digital piano: what truly matters','excerpt'=>'Key action, sound engines, pedals and connectivity explained in plain language for confident first-time buyers.','image'=>'images/hero/grid-banner-piano.jpg','date'=>'July 18, 2026','read'=>'7 min read'],
    ];
@endphp
