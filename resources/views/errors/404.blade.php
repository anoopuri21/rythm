...
@section('content')
    <div class="bg-paper">
        <div class="mx-auto flex min-h-[60vh] max-w-lg flex-col items-center justify-center px-5 py-20 text-center sm:px-8">
            ...
            <h1 class="mt-2 font-playfair text-3xl font-bold text-ink sm:text-4xl">Page not found</h1>
            <p class="mt-4 max-w-md text-sm leading-6 text-muted">
                This address is not available. It may have moved or the link is incomplete.
            </p>
