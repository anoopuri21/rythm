                    ...
                    ->schema([
                        RepeatableEntry::make('items')
                            ->schema([
                                ...
                                TextEntry::make('tax_rate_snapshot')->label('GST rate')->suffix('%')->placeholder('Off'),
                                TextEntry::make('taxable_amount_snapshot')->label('Taxable')->money('INR')->placeholder('Off'),
                                TextEntry::make('cgst_amount_snapshot')->label('CGST')->money('INR')->placeholder('—'),
                                TextEntry::make('sgst_amount_snapshot')->label('SGST')->money('INR')->placeholder('—'),
                                TextEntry::make('igst_amount_snapshot')->label('IGST')->money('INR')->placeholder('—'),
                                TextEntry::make('gst_supply_type_snapshot')->label('Supply')->placeholder('—'),
                                TextEntry::make('tax_amount_snapshot')->label('GST total')->money('INR'),
                                TextEntry::make('tax_origin_region_snapshot')->label('From state')->placeholder('—'),
                                TextEntry::make('tax_destination_region_snapshot')->label('To state')->placeholder('Off'),
                            ])
                            ->columns(6),
                    ]),
